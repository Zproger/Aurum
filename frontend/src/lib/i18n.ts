...
const ru = {
  ...
  "transactions.import.duplicatesFound": "Найдено похожих на уже существующие: {{count}}. Они не будут импортированы.",
...
const en: Record<keyof typeof ru, string> = {
  ...
  "transactions.import.duplicatesFound": "Found {{count}} that look like duplicates of existing transactions. They won't be imported.",
