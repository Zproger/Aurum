...
const ru = {
  ...
  "reports.modeCategory": "По категориям",
  "reports.modeTag": "По тегам",
  "reports.tagLabel": "Тег",
  "reports.noTagsYet": "Тегов пока нет",
  "reports.tagRankingTitle": "Топ тегов за период",
  "reports.noTagRankingData": "За выбранный период нет расходов с тегами.",
  "reports.tagCoverage": "С тегами: {{tagged}} из {{total}}",
  "reports.noCategoryLabel": "Без категории",
...
const en: Record<keyof typeof ru, string> = {
  ...
  "reports.modeCategory": "By category",
  "reports.modeTag": "By tag",
  "reports.tagLabel": "Tag",
  "reports.noTagsYet": "No tags yet",
  "reports.tagRankingTitle": "Top tags for period",
  "reports.noTagRankingData": "No tagged expenses for the selected period.",
  "reports.tagCoverage": "Tagged: {{tagged}} of {{total}}",
  "reports.noCategoryLabel": "No category",
